...
export const REMITTANCE_SCENARIO: Scenario = {
  ...
  nodes: {
    ...
    "purpose-entry": {
      ...
      hint: "고객 답변이 명확한 경우 A, 관련 서류를 지참하신 경우 B, 사유가 모호하거나 확인이 필요한 경우 C로 진행하세요.",
      options: [
        {
          id: "clear",
          label: "A. 사유를 분명히 말씀하신 경우",
          detail: '예: "딸 학비입니다", "수입대금입니다" 등',
          next: "purpose-clear",
        },
        {
          id: "by-doc",
          label: "B. 관련 서류를 지참하신 경우",
          detail: "예: 인보이스·청구서·필증 등 증빙 지참",
          next: "purpose-by-document",
        },
        {
          id: "narrow",
          label: "C. 사유가 모호하거나 확인이 필요한 경우",
          detail: '예: "그냥 보내려고요", "이전부터 하던 거래입니다", "친지에게 보냅니다" 등',
