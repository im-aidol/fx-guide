...
### 영업점 도구
- **당발 송금 도우미** ([app/simulator](app/simulator)) — 고객 답변을 따라 클릭으로 좁혀가며 거래코드·한도·서류·통보 의무·응대 멘트까지 도출하는 트리식 가이드. 입력 금액 기준 임계값(USD 1만/5만/10만)을 자동 점검.
